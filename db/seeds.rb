...
6.times do |i|
  ...
  6.times do |j|
    item = Item.create(name: Faker::Games::DnD.melee_weapon, kind: "artifact", description: Faker::Books::Lovecraft.sentences.join(' '), game_id: game.id)
    skill = Skill.create(name: Faker::Games::Witcher.sign, kind: "elemental", description: Faker::Books::Lovecraft.sentences.join(' '), game_id: game.id)
    ...
    char = Character.create(
      ...
      health: rand(1..max_health), max_health: max_health, energy: rand(1..max_energy), max_energy: max_energy,
      strength: rand(1..game.max_stat), stamina: rand(1..game.max_stat), accuracy: rand(1..game.max_stat), agility: rand(1..game.max_stat), 
      intelligence: rand(1..game.max_stat), wisdom: rand(1..game.max_stat), will: rand(1..game.max_stat), charm: rand(1..game.max_stat),
      item_ids: [item.id], skill_ids: [skill.id],
